...
public class AppSetup extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new ArrayAdapter<String>(AppSetup.this, android.R.layout.simple_list_item_1, arrayListpaired);
        detectedAdapter = new ArrayAdapter<String>(AppSetup.this, android.R.layout.simple_list_item_single_choice);
    ...
    private void startSearching() {
       // Log.i("Log", "in the start searching method");
        ...
        AppSetup.this.registerReceiver(myReceiver, intentFilter);
