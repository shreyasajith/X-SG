...
public class ReceivePacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_packs);
        ...
        addtolist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ReceivePacks.this, "Enter valid Packs", Toast.LENGTH_LONG).show();
                    frompack.setText("");
                    topack.setText("");
                ...
                {
                    Toast.makeText(ReceivePacks.this, "To Pack is less than From Pack", Toast.LENGTH_LONG).show();
                    frompack.setText("");
                    topack.setText("");
                    frompack.requestFocus();
                    ...
                    TableRow newRow = new TableRow(ReceivePacks.this);
                    TextView slno = new TextView(ReceivePacks.this);
                    TextView frm = new TextView(ReceivePacks.this);
                    TextView to = new TextView(ReceivePacks.this);
